...
REM - CALL "$(SolutionDir)scripts\postbuild-win.bat" "$(TargetExt)" "$(BINARY_NAME)" "$(Platform)" "$(COPY_VST2)" "$(TargetPath)" "$(VST2_ARM64_PATH)" "$(VST2_64_PATH)" "$(VST3_ARM64_PATH)" "$(VST3_64_PATH)" "$(AAX_ARM64_PATH)" "$(AAX_64_PATH)" "$(CLAP_PATH)" "$(BUILD_DIR)" "$(VST_ICON)" "$(AAX_ICON)" "
...
set COPY_VST2=%4
set BUILT_BINARY=%5
set VST2_ARM64_PATH=%6
set VST2_64_PATH=%7 
set VST3_ARM64_PATH=%8
set VST3_64_PATH=%9
shift
shift 
shift
...
echo VST2_ARM64_PATH %VST2_ARM64_PATH% 
echo VST2_64_PATH %VST2_64_PATH% 
echo VST3_ARM64_PATH %VST3_ARM64_PATH% 
